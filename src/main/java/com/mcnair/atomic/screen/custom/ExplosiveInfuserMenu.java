...
public class ExplosiveInfuserMenu extends AbstractContainerMenu {
    public final ExplosiveInfuserBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public ExplosiveInfuserMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(7));
    }

    public ExplosiveInfuserMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(AtomicMenuTypes.EXPLOSIVE_INFUSER_MENU.get(), pContainerId);
        checkContainerSize(inv, 6);
        this.blockEntity = ((ExplosiveInfuserBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, AtomicBlocks.EXPLOSIVE_INFUSER.get());
    }
