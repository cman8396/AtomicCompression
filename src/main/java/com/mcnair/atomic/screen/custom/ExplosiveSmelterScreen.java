...
public class ExplosiveSmelterScreen extends AbstractContainerScreen<ExplosiveSmelterMenu> {
    private static final Identifier GUI_TEXTURE =
            Identifier.fromNamespaceAndPath(AtomicCompression.MOD_ID, "textures/gui/explosive_smelter.png");
    ...
    private static final Identifier PROCESS_ICON =
            Identifier.fromNamespaceAndPath(AtomicCompression.MOD_ID, "textures/gui/active_icons/active_smelter.png");
    ...
    public ExplosiveSmelterScreen(ExplosiveSmelterMenu menu, Inventory playerInventory, Component title) {
