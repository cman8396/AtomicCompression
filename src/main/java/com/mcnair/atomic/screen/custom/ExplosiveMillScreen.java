...
public class ExplosiveMillScreen extends AbstractContainerScreen<ExplosiveMillMenu> {
    private static final Identifier GUI_TEXTURE =
            Identifier.fromNamespaceAndPath(AtomicCompression.MOD_ID, "textures/gui/explosive_mill.png");
    ...
    private static final Identifier PROCESS_ICON =
            Identifier.fromNamespaceAndPath(AtomicCompression.MOD_ID, "textures/gui/active_icons/active_mill.png");
    ...
    public ExplosiveMillScreen(ExplosiveMillMenu menu, Inventory playerInventory, Component title) {
