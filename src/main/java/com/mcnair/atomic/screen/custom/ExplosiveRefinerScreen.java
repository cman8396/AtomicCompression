...
public class ExplosiveRefinerScreen extends AbstractContainerScreen<ExplosiveRefinerMenu> {
    ...
    private static final Identifier PROCESS_ICON =
            Identifier.fromNamespaceAndPath(AtomicCompression.MOD_ID, "textures/gui/active_icons/active_refiner.png");
    ...
    private void renderProgressArrow(GuiGraphics guiGraphics, int x, int y) {
        if (menu.isCrafting()) {
            ...
            guiGraphics.blit(RenderPipelines.GUI_TEXTURED, PROCESS_ICON, x + 53, y + 56, 0, 0, 16, 16, 16, 16);
        }
    }
