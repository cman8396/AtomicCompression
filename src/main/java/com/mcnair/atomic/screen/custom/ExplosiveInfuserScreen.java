...
public class ExplosiveInfuserScreen extends AbstractContainerScreen<ExplosiveInfuserMenu> {
    private static final Identifier GUI_TEXTURE =
            Identifier.fromNamespaceAndPath(AtomicCompression.MOD_ID, "textures/gui/explosive_infuser.png");
    ...
    private static final Identifier PROCESS_ICON =
            Identifier.fromNamespaceAndPath(AtomicCompression.MOD_ID, "textures/gui/active_icons/active_infuser.png");
    ...
    public ExplosiveInfuserScreen(ExplosiveInfuserMenu menu, Inventory playerInventory, Component title) {
