...
public class ExplosiveSeparatorScreen extends AbstractContainerScreen<ExplosiveSeparatorMenu> {
    ...
    private static final Identifier PROCESS_ICON =
            Identifier.fromNamespaceAndPath(AtomicCompression.MOD_ID, "textures/gui/active_icons/active_separator.png");
