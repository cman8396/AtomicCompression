...
public class AtomicItems {
    ...
    public static final DeferredItem<Item> IRON_PLATE = ITEMS.register("iron_plate", registryName -> new Item(new Item.Properties().setId(ResourceKey.create(Registries.ITEM, registryName))));
    public static final DeferredItem<Item> GOLD_PLATE = ITEMS.register("gold_plate", registryName -> new Item(new Item.Properties().setId(ResourceKey.create(Registries.ITEM, registryName))));
    public static final DeferredItem<Item> LEAD_PLATE = ITEMS.register("lead_plate", registryName -> new Item(new Item.Properties().setId(ResourceKey.create(Registries.ITEM, registryName))));
    public static final DeferredItem<Item> BRIGHTSILVER_PLATE = ITEMS.register("brightsilver_plate", registryName -> new Item(new Item.Properties().setId(ResourceKey.create(Registries.ITEM, registryName))));
    public static final DeferredItem<Item> BRIGHTSILVER_ALLOY_PLATE = ITEMS.register("brightsilver_alloy_plate", registryName -> new Item(new Item.Properties().setId(ResourceKey.create(Registries.ITEM, registryName))));
    public static final DeferredItem<Item> BUNGERITE_PLATE = ITEMS.register("bungerite_plate", registryName -> new Item(new Item.Properties().setId(ResourceKey.create(Registries.ITEM, registryName))));
    public static final DeferredItem<Item> BUNGERITE_ALLOY_PLATE = ITEMS.register("bungerite_alloy_plate", registryName -> new Item(new Item.Properties().setId(ResourceKey.create(Registries.ITEM, registryName))));
    public static final DeferredItem<Item> SOULSTEEL_PLATE = ITEMS.register("soulsteel_plate", registryName -> new Item(new Item.Properties().setId(ResourceKey.create(Registries.ITEM, registryName))));
    ...
    //SOULSTEEL
    public static final DeferredItem<Item> SOULSTEEL_ALLOY_SWORD = ITEMS.register("soulsteel_alloy_sword", registryName -> new Item(new Item.Properties().sword(AtomicToolTiers.SOULSTEEL_ALLOY, 4f, -2.6f).rarity(Rarity.RARE).setId(ResourceKey.create(Registries.ITEM, registryName))));
    public static final DeferredItem<Item> SOULSTEEL_ALLOY_SPEAR = ITEMS.register("soulsteel_alloy_spear", registryName -> new Item(new Item.Properties().spear(AtomicToolTiers.SOULSTEEL_ALLOY, 1.25f, 1.5f, 0.35f, 2.2f, 6.75f, 5.25f, 5.1f, 8f, 4.6f).rarity(Rarity.RARE).setId(ResourceKey.create(Registries.ITEM, registryName))));
    public static final DeferredItem<ShovelItem> SOULSTEEL_ALLOY_SHOVEL = ITEMS.register("soulsteel_alloy_shovel", registryName -> new ShovelItem(AtomicToolTiers.SOULSTEEL_ALLOY, 1.5f, -3.2f, new ShovelItem.Properties().rarity(Rarity.RARE).setId(ResourceKey.create(Registries.ITEM, registryName))));
    public static final DeferredItem<PickaxeItem> SOULSTEEL_ALLOY_PICKAXE = ITEMS.register("soulsteel_alloy_pickaxe", registryName -> new PickaxeItem(AtomicToolTiers.SOULSTEEL_ALLOY, 1.0f, -3f, new PickaxeItem.Properties().rarity(Rarity.RARE).setId(ResourceKey.create(Registries.ITEM, registryName))));
    public static final DeferredItem<AxeItem> SOULSTEEL_ALLOY_AXE = ITEMS.register("soulsteel_alloy_axe", registryName -> new AxeItem(AtomicToolTiers.SOULSTEEL_ALLOY, 5.2f, -3.0f, new ShovelItem.Properties().rarity(Rarity.RARE).setId(ResourceKey.create(Registries.ITEM, registryName))));
    public static final DeferredItem<HoeItem> SOULSTEEL_ALLOY_HOE = ITEMS.register("soulsteel_alloy_hoe", registryName -> new HoeItem(AtomicToolTiers.SOULSTEEL_ALLOY, -4.0f, 0.0f, new ShovelItem.Properties().rarity(Rarity.RARE).setId(ResourceKey.create(Registries.ITEM, registryName))));
    ...
    /* IGNITERS */
    public static final DeferredItem<Item> BRIGHTSILVER_IGNITER = ITEMS.register("brightsilver_igniter", registryName -> new FlintAndSteelItem(new Item.Properties().durability(256).setId(ResourceKey.create(Registries.ITEM, registryName))));
    public static final DeferredItem<Item> BUNGERITE_IGNITER = ITEMS.register("bungerite_igniter", registryName -> new FlintAndSteelItem(new Item.Properties().durability(2024).setId(ResourceKey.create(Registries.ITEM, registryName))));
    public static final DeferredItem<Item> SOULSTEEL_IGNITER = ITEMS.register("soulsteel_igniter", registryName -> new FlintAndSteelItem(new Item.Properties().durability(8192).setId(ResourceKey.create(Registries.ITEM, registryName))));
