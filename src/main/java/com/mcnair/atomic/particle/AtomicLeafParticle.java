...
public class AtomicLeafParticle extends SingleQuadParticle {
    ...
    public AtomicLeafParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet, TextureAtlasSprite sprite) {
