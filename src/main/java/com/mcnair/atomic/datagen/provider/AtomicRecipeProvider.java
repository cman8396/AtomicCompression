...
public class AtomicRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        allTools(output, AtomicItems.SOULSTEEL_ALLOY_INGOT, AtomicItems.INFUSED_BASALT_TOOL_SHAFT, AtomicItems.SOULSTEEL_ALLOY_SWORD, AtomicItems.SOULSTEEL_ALLOY_SPEAR, AtomicItems.SOULSTEEL_ALLOY_PICKAXE, AtomicItems.SOULSTEEL_ALLOY_AXE, AtomicItems.SOULSTEEL_ALLOY_SHOVEL, AtomicItems.SOULSTEEL_ALLOY_HOE);
