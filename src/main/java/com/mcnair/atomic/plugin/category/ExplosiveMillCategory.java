...
public class ExplosiveMillCategory implements IRecipeCategory<RecipeHolder<ExplosiveMillRecipe>> {
    public static final IRecipeHolderType<ExplosiveMillRecipe> TYPE = IRecipeHolderType.create(ExplosiveMillRecipe.Type.INSTANCE);

    private final IDrawable background;
    private final IDrawable icon;

    public ExplosiveMillCategory(IGuiHelper helper) {
        ...
        icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(AtomicBlocks.EXPLOSIVE_MILL.get()));
    }

    @Override
    public IRecipeHolderType<ExplosiveMillRecipe> getRecipeType() {
        return TYPE;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder iRecipeLayoutBuilder, RecipeHolder<ExplosiveMillRecipe> recipe, IFocusGroup iFocusGroup) {
    ...
    @Override
    public void draw(RecipeHolder<ExplosiveMillRecipe> recipe, IRecipeSlotsView iRecipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
