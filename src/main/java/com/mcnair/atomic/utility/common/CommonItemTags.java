...
public final class CommonItemTags {
    ...
    public static final TagKey<Item> ORES_BRIGHTSILVER = TagKey.create(Registries.ITEM,
    ...
    public static final TagKey<Item> ORES_SOULSTEEL = TagKey.create(Registries.ITEM,
    ...
    public static final TagKey<Item> STORAGE_BLOCKS_RAW_BRIGHTSILVER = TagKey.create(Registries.ITEM,
    ...
    public static final TagKey<Item> STORAGE_BLOCKS_RAW_SOULSTEEL = TagKey.create(Registries.ITEM,
    ...
    public static final TagKey<Item> RAW_MATERIALS_BRIGHTSILVER = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "raw_materials/brightsilver"));
    ...
    public static final TagKey<Item> RAW_MATERIALS_SOULSTEEL = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "raw_materials/soulsteel"));
    ...
    public static final TagKey<Item> DUSTS_ENDER = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "dusts/ender"));
    public static final TagKey<Item> DUSTS_DIAMOND = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "dusts/diamond"));
    public static final TagKey<Item> DUSTS_EMERALD = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "dusts/emerald"));
    public static final TagKey<Item> DUSTS_ECHO = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "dusts/echo"));
    ...
    public static final TagKey<Item> TOOL_SHAFTS_WOODEN = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "tool_shafts/wooden"));
    public static final TagKey<Item> TOOL_SHAFTS_DENSE = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "tool_shafts/dense"));
    public static final TagKey<Item> TOOL_SHAFTS_ELEMENTAL = TagKey.create(Registries.ITEM,
            Identifier.fromNamespaceAndPath("c", "tool_shafts/elemental"));
